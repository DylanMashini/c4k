...
const ROWS: Row[] = [
  ...
  { ix: "09", name: "Front swivel castor", sub: "Single freewheeling wheel under the front of the chassis", kind: "Hardware", qty: "1", source: "C4K kit" },
  ...
  return (
    <section className="section" id="bom">
      <div className="sec-head">
        ...
        <p>
          Printed parts come from the supplied <code>.3mf</code> files. Everything else is in the C4K
          Micro:Bit kit or the class hardware bin.
        </p>
      </div>
